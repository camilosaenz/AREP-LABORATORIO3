...
/**
 * Metodo prinsipal encargado de iniciar el llamado con las demas clases, es esta clase en especifico se mostrara informacion en una pagina "/Apps/about", en la cual se mostrara un mensaje introductorio.
 * @author Camilo
 *
 */
public class App{
